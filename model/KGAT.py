...
class KGAT(BaseModel):
    ...
    def get_neighbors(self, entities):
        ...
        for entity_batch in entities:
            ...
            for entity in entity_batch:
                ...
                if type(entity) == int:
                    if len(self.adj_entity[entity]) == 0 or len(self.adj_relation[entity]) == 0:
                      entity = 0
                    ...
                    for entity_i in entity:
                        if len(self.adj_entity[entity_i]) == 0 or len(self.adj_relation[entity_i]) == 0:
                            entity_i = 0
    ...
    def forward(self, entity_ids):
        ...
        # print(len(self.entity_embedding))
        # print(len(entity_ids))
        # print(len(self.relation_embedding))
        # print(len(neighbor_entities))
